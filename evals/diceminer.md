...
The BEFORE and AFTER technical gates are frozen before model evaluation.

The preregistered Codex benchmark is:

- model: `gpt-5.5`;
- reasoning effort: `low`;
- 10 independent BEFORE runs;
- 10 independent AFTER runs;
...
No DiceMiner model result is claimed in this document until those runs are
actually collected.
