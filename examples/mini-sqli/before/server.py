...
RUNTIME_ROOT = tempfile.mkdtemp(prefix="nicetrygpt-sqli-before-")
    ...
    with sqlite3.connect(DB_PATH) as db:
        ...
        db.executemany(
            ...
            [
                ...
                ("admin@tinysql.local", "not-player-facing", "admin", FLAG),
            ],
        )
    ...
    def do_GET(self):
        ...
        if parsed.path == "/":
            return self.send_text(
                ...
                "Admin account: admin@tinysql.local\n"
        ...
        if parsed.path == "/login":
            ...
            # Intentional CTF vulnerability: direct string interpolation.
            query = (
