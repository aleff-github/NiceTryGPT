...
This file keeps public messaging consistent while NiceTryGPT is still an early proof of concept.
...
>
> I released **NiceTryGPT v0.1.0**: a tiny Agent Skill that solves an existing CTF first, identifies cheap LLM shortcuts, then applies the smallest possible transformation while preserving the vulnerability and human difficulty.
>
> Two reproducible demos are included: IDOR and path traversal.
>
...
>
> v0.1.0 includes two dependency-free before/after demos (IDOR and path traversal), CI tests for shortcut reduction, and a fresh-context evaluation protocol. I am not claiming the examples are AI-proof; independent multi-model results are intentionally not published until they are actually run.
>
...
>
> I’ve published a v0.1.0 with two tiny reproducible examples and would be interested in feedback from challenge authors on whether the methodology matches real CTF design constraints:
>
> https://github.com/aleff-github/NiceTryGPT
...
- the IDOR before/after table;
- the path-traversal before/after table;
- green E2E tests;
- the Human Cost Gate;
- the downloadable v0.1.0 release.
